...
const CourseDetails = () => {
  ...
  const toggleSection = (index) => {
    // In this we get the previous value
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative isolate items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-slate-600">
          ...
          <p>
            Course by{" "}
            <span className="text-emerald-600 underline">{courseData.educator.name}</span>
          </p>
        ...
        <div
          class="shadow-custom"
          className="shadow-custom max-w-[424px] z-10 rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]"
        >
          {playerData ? (
            <Youtube
